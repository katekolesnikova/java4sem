package bsu.rfe.java.group10.lab8.Masyuk.A4.servlets;
...
import bsu.rfe.java.group10.lab8.Masyuk.A4.entity.ChatUser;
...
// восстановить имя через cookie
        ...
        // Вывести форму
        pw.println("<form action='/Java-Lab-8/' method='post'>Введите имя:" +
...
// от множества пользователей
        ...
        if (aUser.getSessionId().equals(sessionId) ||
            ...
            response.sendRedirect(response.encodeRedirectURL("/Java-Lab-8/view.html"));
